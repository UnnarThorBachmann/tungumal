export let db = [{mynd: 'rocket', svar: 'eldflaug'},
					...
					{mynd: 'euro', svar: 'evra'},
					{mynd: 'bug', svar: 'padda'},
					{mynd: 'camera', svar: 'myndavél'},
					{mynd: 'envelope', svar: 'umslag'},
					{mynd: 'globe', svar: 'jörðin'},
					{mynd: 'gift', svar: 'gjöf'},
					{mynd: 'industry', svar: 'verksmiðja'},
					{mynd: 'key', svar: 'lykill'},
					{mynd: 'laptop', svar: 'tölva'},
					{mynd: 'mobile', svar: 'farsími'},
					{mynd: 'pencil', svar: 'blýantur'},
					{mynd: 'road', svar: 'vegur'},
					{mynd: 'sun-o', svar: 'sólin'},
					{mynd: 'thropy', svar: 'bikar'},
					{mynd: 'umbrella', svar: 'regnhlíf'},
];
